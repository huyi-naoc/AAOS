...
#define DOME_COMMAND_OPEN_WINDOW				4
#define DOME_COMMAND_CLOSE_WINDOW				5
#define DOME_COMMAND_STOP_WINDOW				6
#define DOME_COMMAND_INSPECT					7
#define DOME_COMMAND_REGISTER					8
#define DOME_COMMAND_STATUS						9
#define DOME_COMMAND_GET_WINDOW_POSITION		10
#define DOME_COMMAND_GET_WINDOW_OPEN_SPEED		11
...
int dome_open_window(void *_self);
int dome_close_window(void *_self);
int dome_stop_window(void *_self);
...
int dome_get_window_position(void *_self, double *position);
int dome_get_window_open_speed(void *_self, double *speed);
